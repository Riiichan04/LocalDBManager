        ...
        <div className="py-2 h-full overflow-auto">
            ...
            <div className="grid-cols-12 grid mt-10 ps-2">
                <div className="col-span-2">
                    <div className={`rounded cursor-pointer h-fit p-2 select-none flex gap-2 ${activeSetting === "display" ? 'active-table-bar' : ''}`}
                        onClick={() => setActiveSetting("display")}
                    >
                        <BrushRoundedIcon />
                        <p>Hiển thị</p>
                    </div>
                    <div className={`rounded cursor-pointer h-fit p-2 select-none col-span-2 flex gap-2 ${activeSetting === "info" ? 'active-table-bar' : ''}`}
                ...
                <div className="col-span-10 p-2 ms-5">
                    ...
                    {activeSetting === "info" &&
                        <div className="flex flex-col mt-1">
                            ...
                            <div>
                                <p className="mb-3">Phiên bản hiện tại: <h5 className="font-semibold inline">v1.0.0</h5></p>
